...
user_idea: $(cat .claude/input/scaffold_description.md)
gold_standard_rules: $(cat .claude/specs/frontend-gold-specs.md)
...
- **Output:** Create the plan in `.claude/specs/` with filename: `plan-{current_date}-{plan_id}.md`.
